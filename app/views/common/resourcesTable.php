      ...
      <form action="<?php echo URLROOT; ?>/OwnDashboard/resources" method="post">
         ...
         <div class="addItemsModalGrid1 ownResAddDetails">
            <div class="ownResAddDetail1">
               ...
               <input type="text" name="resourceName" class="ownResAddLabeltext" placeholder="--Type in--"
                  value="<?php echo $data['resourceName'];?>" maxlength="40">
               <br>
         ...
         <div class="addItemsModalGrid3">
            <div class="addItemsModalbtn1">
               <button class="btn btnClose normal ModalCancelButton ModalButton " name="action"
