...
<body class="layout-template-1">
   ...
   <div class="content own resources">
      ...
      <div class="page-top-main-container">
         <a href="<?php echo URLROOT ?>/resources/addResource"
            class="btn btn-filled btn-theme-purple btn-main btnAddResourceBtn"
               ...
               <div class="row">
                  <div class="column">
                     <div class="text-group">
                        ...
                        <input type="text" name="" id="resourceIDInput"
                           value="<?php echo ($data["typedID"]== "all")? "": $data["typedID"];?>"
                  ...
                  <div class="column">
                     <div class="text-group">
                        ...
                        <input type="text" name="" id="resourceNameInput"
                           value="<?php echo ($data["typedName"] == "all")? "":$data["typedName"];?>"
