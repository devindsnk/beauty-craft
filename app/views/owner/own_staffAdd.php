                            ...
                            <div class="ownAddstaffMaingrid1">
                                ...
                                <div class="ownAddstaffFormGroupImage">
                                    <div class="ownAddstaffBasicinfoFilesubBtn">
                                        <label for="ownAddstaffBasicinfoImagesub"
                                            ...
                                            <img src="<?php echo URLROOT ?>/public/imgs/staffImgs/<?php echo $data['staffimagePath']; ?> "
                                                class="ownAddstaffBasicinfoIcon" id='profileImg' height="160px"
                                                width="160px" borderRadious='50%'> <br>
                                            <?php endif; ?>
                                ...
                                <div class="ownAddstaffFormGroupRadio">
                                    ...
                                    <div class="ownAddstaffBasicinfoRadiowrapper">
                                        ...
                                        <input type="radio" name="gender" id="option-1" class="genderMale" value="M"
                                            <?php if ($data['gender'] == 'M') echo 'checked'; ?> onclick="return false;"
>
                                        <label for="option1"> Male</label> <br>
                                        <input type="radio" name="gender" id="option-2" class="genderFemale" value="F"
                                            <?php if ($data['gender'] == 'F') echo 'checked'; ?> onclick="return false;"
>
                            ...
                            <div class="ownAddstaffMaingrid2">
                                <div class="ownAddstaffFormGroupDOB">
                                    ...
                                    <input type="date" name="staffDOB" class="Date" id="dateOfBirth"
                                        value="<?php echo $data['staffDOB']; ?>" readonly="readonly">
                                ...
                                <div class="ownAddstaffFormGroupStype">
                                    ...
                                    <select name="staffType" class="dropdownselectbox">
                                        <option class="unbold" value="0" option selected="true" disabled="disabled">
                                            Select</option>
                                        <option value=5 <?php if ($data['staffType'] == 5) echo 'selected'; ?>>Service
                                            Provider</option>
                                        <option value=4 <?php if ($data['staffType'] == 4) echo 'selected'; ?>>
                                            Receptionist</option>
                                        <option value=3 <?php if ($data['staffType'] == 3) echo 'selected'; ?>>Manager
                                        </option>
                                    </select>
