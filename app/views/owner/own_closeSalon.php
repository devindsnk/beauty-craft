         ...
         <div class="modal-box" id="ownCloseSalonContainer">
            ...
            <div class="ownCloseSalonGrid1">
               ...
               <div class="ownCloseSalonDetail2">
                  ...
                  <textarea id="ownCloseSalonTextArea" name="ownCloseSalonTextArea" rows="4" cols="50"
            ...
            <div class="ownCloseSalonGrid2">
               <div class="ownCloseSalonError">
                  ...
                  <a href="#" class="ownCloseSalonErrorAnchortag"> <label class="ownCloseSalonErrorViewReservaions">View
                        Reservaions</label></a>
               </div>
