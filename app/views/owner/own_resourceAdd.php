                            ...
                            <div class="Maingrid1">
                                <div class="manufacturer">
                                    ...
                                    <input type="text" name="manufacturer" id="contactnum"
                                        placeholder="Resource manufacturer here" value="<?php echo $data['manufacturer']; ?>">
                                ...
                                <div class="modelNumber">
                                    ...
                                    <input type="text" name="modelNo" id="email" placeholder="Resource model number here"
                                        value="<?php echo $data['modelNo']; ?>">
                            ...
                            <div class="Maingrid4">
                                ...
                                <div class="quantity">
                                    ...
                                    <!-- <input type="text" name="staffAccBank" id="accbank"
                                        placeholder="Your bank name here" value=""> -->
