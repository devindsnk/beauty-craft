         ...
         <div class="leaverequesttable">
               ...
               <div class="options-container">
                  <div class="left-section">
                     <div class="row statusopt">
                        <div class="column">
                           <div class="dropdown-group"><label class="label" for="lName">Status</label><select name="lstatus" id="lstatus">
                  ...
                  <table class="table2-hover" id="leaveReqTable">
                     ...
                     <tbody>
                        <tr>
                           ...
                           <td data-lable="Action" class="column-center-align"><span><button class="editicon btnEditLeave"><a href="#" data-a=""><i class="ci-edit table-icon"></i></a></button><button class="editicon btnDeleteLeave"><a><i class="ci-trash table-icon"></i></a></button></span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           ...
                           <td data-lable="Status" class="column-center-align">
                              <button type="button" class="table-btn green-status-btn text-uppercase" value="Approved">
                                 Approved </button>
                           </td>
                           <td data-lable="Action" class="column-center-align"><span><button class="editicon btnEditLeave"><a href="#" data-a=""><i class="ci-edit table-icon"></i></a></button><button class="editicon btnDeleteLeave"><a><i class="ci-trash table-icon"></i></a></button></span></td>
                        </tr>
                        <tr>
                           ...
                           <td data-lable="Status" class="column-center-align"><button type="button" class="table-btn red-status-btn text-uppercase value=" Rejected"> Rejected </button>
            ...
            <div class="modal-container leaverequest ">
               <div class="modal-box leave_request">
                  ...
                  <form action="<?php echo URLROOT; ?>/SerProvDashboard/leaves" class="form" method="POST">
                     <div class="row">
                        <div class="column">
                           <div class="text-group"><label class="labels" for="serviceName">Date</label><br><input type="date" name="date" id="takeLeaveDate" placeholder="--Select a date--" value="<?php echo $data['date']; ?>"></div><span class="error"><?php echo $data['date_error'];
                                                                                                                                                                                                                                                            ?></span>
                        </div>
                     </div>
                     <div class="row">
                        <div class="column">
                           <div class="text-group"><label class="labels" for="serviceName">Reason</label><br><textarea type="text" name="reason" id="takeLeaveReason" placeholder="-- Type in --" class="" value="<?php echo $data['reason']; ?>"></textarea><span class="error"><?php echo $data['reason_error'];
                                                                                                                                                                                                                                                                                 ?></span>
                           </div>
                        </div>
                     </div>
                     <div class="modalbutton">
                        <div class="btn1"><button type="submit" name="action" value="cancel" class="close-type-btn btn btnClose ">Cancel</button></div>
                        <div class="btn2"><button type="submit" name="action" value="addleave" class="confirm-service-btn">Request</button></div>
                     </div>
                  </form>
               </div>
            </div>
            ...
            <div class="modal-container edit-leave">
               <div class="modal-box leave_request">
                  ...
                  <form>
                     <div class="row">
                        <div class="column">
                           <div class="text-group"><label class="labels" for="serviceName">Date</label><br><input type="date" vale="2021-10-15" placeholder="--Select a date--" value="<?php echo $data['leaveData']; ?>">
                           </div>
                        </div>
                     </div>
                     <div class="row">
                        <div class="column">
                           <div class="text-group"><label class="labels" for="serviceName">Reason</label><br><textarea type="text" placeholder="-- Type in --" value="<?php echo $data['reason']; ?>"><?php if ($data['reason'] == $data['reasonenterd']) echo $data['reason'];
                                                                                                                                                                                                      ?></textarea>
                           </div>
                        </div>
                     </div>
                     <div class="modalbutton">
                        <div class="btn1"><button type="submit" name="action" value="cancel" class="close-type-btn btn btnClose ">Cancel</button></div>
                        <div class="btn2"><button type="submit" name="action" value="addleave" class="edit-leave confirm-service-btn">Save Changes</button></div>
                     </div>
                  </form>
               </div>
            </div>
            ...
            <div class="modal-container delete-leave">
               <div class="modal-box leave_delete">
                  ...
                  <div class="modalbutton">
                     <div class="btn1"><button type="submit" name="action" value="cancel" class="close-type-btn btn btnClose ">Cancel</button></div>
                     <div class="btn2"><button type="submit" name="action" value="deleteLeave" class="delete leave confirm-service-btn">Proceed</button></div>
                  </div>
               </div>
            </div>
