					...
					<div class="newService-sub">
						...
						<div class="row">
							<div class="column">
								...
								<input type="text" name="" id="serviceCusCategory" placeholder="<?php if ($sDetails->customerCategory == 1) : ?>Gents<?php elseif ($sDetails->customerCategory == 2) : ?>Ladies<?php else : ?>Ladies & Gents<?php endif; ?>" disabled>
