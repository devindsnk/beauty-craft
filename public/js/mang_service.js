    ...
    $(document).ready(function(){
        ...
        $('#addDiv').append('<div class="newService-sub" id="fullSlotDetail'+j+'"><div class="btn-remove quantity-align"> <a href="#fullSlotDetail'+j+'" name="remove" id="'+i+'" class="close-slot"><i class="fas fa-times fa-1g"></i><br/></a></div><h4 class="paddingBottom">Slot '+i+'</h4><div class="row"><div class="column"><div class="row2" id="intervalDetails'+j+'"><label class="labels">Interval Duration</label><br><select class="dropdownSelectBox"><option value="val1">1 min</option><option value="val2">2 min</option><option value="val1">3 min</option></select></div><div class="row3" id="slotDetails'+i+'"><label class="labels">Slot Duration</label><br><select class="dropdownSelectBox"> <option value="val1">1 min</option><option value="val2">2 min</option></select></div></div><div class="column" id="resorceDetails'+i+'"><label>Resources and Quantity</label><div class="checkbox-div"><div class="divIndiv"><label class="labels">Res111, Resource1</label><select class="dropdownSelectBox-small quantity-align"><option value="val1">0</option><option value="val1">1</option></select></div><hr class="resHr"><div class="divIndiv"><label class="labels">Res111, Resource1</label><select class="dropdownSelectBox-small quantity-align"><option value="val1">0</option><option value="val1">1</option></select></div><hr class="resHr"><div class="divIndiv"><label class="labels">Res111, Resource1</label><select class="dropdownSelectBox-small quantity-align"><option value="val1">0</option><option value="val1">1</option></select></div><hr class="resHr"></div></div></div></div> </form>');
